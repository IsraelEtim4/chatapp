  ...
  return(
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.form}>
        ...
        />
        <TouchabelOpasity
          style={styles.button} onPress={onHandleSignup}>
          <Text style={{fontWeight: 'bold',color: '#fff',fontSize: 10}}>Log In</Text>
        </TouchabelOpasity>
        <View style={{marginTop: 20, flexDirection: 'row', alignItems: 'center', alignSelf: 'center'}}>
          <Text style={{color: 'gray', fontWeight: 600, fontSize: 14}}>Do have an account?</Text>
          <TouchabelOpasity onPress={() => navigation.navigate("Login")}>
